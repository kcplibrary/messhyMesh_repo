...
const ToastNotification = ({
  ...
  return (
    <div
      className={`fixed top-6 right-6 z-50 max-w-sm w-full bg-slate-900/70 backdrop-blur-xl border ${colors.border} rounded-xl shadow-2xl ${colors.glow} flex items-stretch gap-4 overflow-hidden animate-in slide-in-from-right-8 fade-in-0 duration-300 select-none`}
    >
      ...
      <div className="flex-1 py-4 pr-1">
        <div className="flex items-center gap-2">
          <span
            className={`text-[10px] font-mono font-black tracking-widest uppercase px-2 py-0.5 rounded-md ${colors.bg}`}
          >

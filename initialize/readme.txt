...
Evidentia:
Terminal 1: cd /usr/share/phpmyadmin && sudo php -S localhost:8080   //mysql database server
Terminal 2: cd Documents/evidentia/backend && php -S 127.0.0.1:8081  //backend server
